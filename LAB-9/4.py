...
#TASK_4
def undirected_matrix(graph):
  return graph.to_undirected()

def undirected_list(graph):
  return graph.to_undirected()

# Test Task 4
print("\nTask 4 - Convert to Undirected:")
undirected_matrix = undirected_matrix(directed_matrix)
undirected_list = undirected_list(directed_list)
print("Matrix is undirected:", not undirected_matrix.directed)  # Expected: True
print("List is undirected:", not undirected_list.directed)      # Expected: True
