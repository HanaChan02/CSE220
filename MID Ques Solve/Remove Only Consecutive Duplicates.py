...
def main():
    ...
    head1.next.next.next.next = Node(102)
    head1.next.next.next.next.next = Node(102)
    head1.next.next.next.next.next.next = Node(104)
    head1.next.next.next.next.next.next.next = Node(105)
    head1.next.next.next.next.next.next.next.next = Node(105)
